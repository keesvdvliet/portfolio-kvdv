...
const planets = {
  earth: [earthTexture, 0.25, 0.45, 0.025, false],
  mars: [marsTexture, 0.09, 0.95, 0.045, false],
  uranus: [uranusTexture, 0.3, 0.65, 0.035, true],
};
...
function Planet({ name }) {
  ...
  return (
    <>
      ...
      {planetRings && (
        <mesh ref={ringsRef} rotation-x={degreesToRadians(80)}>
          <circleGeometry args={[planetSize + 0.15, 32]} />
